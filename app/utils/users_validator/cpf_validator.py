...
class CPFValidator:
    def __init__(self, cpf: str):
        """Inicializa a classe com o CPF limpo e prepara os dígitos"""
    ...
    def check_repetition(self) -> bool:
        """Verifica se o CPF contém todos os dígitos idênticos."""
    ...
    def validate_cpf(self) -> bool:
        ...
        if self.check_repetition():
            raise ValidationError("CPF inválido! O CPF não pode ser sequencial.")
